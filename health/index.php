...
$config->titleTag = 'RSS News Feed - HEALTH';

#Fills <meta> tags.  Currently we're adding to the existing meta tags in config_inc.php
$config->metaDescription = 'RSS News Feeds - HEALTH' . $config->metaDescription;
...
echo '<h3 align="center">Health</h3>';
	...
	{# process each row
		...
		<div class="row" style="flex-direction: row;">
			<div class="col-lg-4 card mb-3" style="width: 25%; display:flex; justify-content: space-between;">
  				<h3 class="card-header"><a href="' . VIRTUAL_PATH . 'health/wellness/feed_view.php?id=' . (int)$row['FeedID'] . '">Wellness</h3>
  				<div class="card-body">
    				<h5 class="card-title">Special title treatment</h5>
    				<h6 class="card-subtitle text-muted">Support card subtitle</h6>
  				</div>
  				<img style="height: 200px; width: 100%; display: block;" src="../images/wellness.jpg" alt="wellness image">
  				<div class="card-body">
			...
			<div class="col-lg-4 card mb-3" style="width: 25%; display: flex; justify-content: space-between;">
				<h3 class="card-header"><a href="' . VIRTUAL_PATH . 'health/nutrition/feed_view.php?id=' . (int)$row['FeedID'] . '">Nutrition</h3>
				<div class="card-body">
					<h5 class="card-title">Special title treatment</h5>
					<h6 class="card-subtitle text-muted">Support card subtitle</h6>
				</div>
				<img style="height: 200px; width: 100%; display: block;" src="../images/nutrition.jpg" alt="nutrition image">
				<div class="card-body">
					<p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p>
				</div>
					<ul class="list-group list-group-flush">
			...
			<div class="col-lg-4 card mb-3" style="width: 25%; display: flex; justify-content: space-between;">
				<h3 class="card-header"><a href="' . VIRTUAL_PATH . 'health/fitness/feed_view.php?id=' . (int)$row['FeedID'] . '">Fitness</h3>
				<div class="card-body">
					<h5 class="card-title">Special title treatment</h5>
					<h6 class="card-subtitle text-muted">Support card subtitle</h6>
				</div>
				<img style="height: 200px; width: 100%; display: block;" src="../images/fitness.jpg" alt="fitness image">
				<div class="card-body">
					<p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p>
				</div>
					<ul class="list-group list-group-flush">
