...
$config->titleTag = 'RSS News Feed - SPORTS';

#Fills <meta> tags.  Currently we're adding to the existing meta tags in config_inc.php
$config->metaDescription = 'RSS News Feeds - SPORTS' . $config->metaDescription;
...
echo '<h3 align="center">Sports</h3>';
...
{#records exist - process
	...
	{# process each row
		...
		<div class="col-lg-4 card mb-3" style="width: 25%; display:flex; justify-content: space-between;">
			  <h3 class="card-header"><a href="' . VIRTUAL_PATH . 'sports/mlb/feed_view.php?id=' . (int)$row['FeedID'] . '">MLB</h3>
			  <div class="card-body">
				<h5 class="card-title">Special title treatment</h5>
				<h6 class="card-subtitle text-muted">Support card subtitle</h6>
			  </div>
			  <img style="height: 200px; width: 100%; display: block;" src="../images/mlb.jpg" alt="wellness image">
			  <div class="card-body">
		...
		<div class="col-lg-4 card mb-3" style="width: 25%; display: flex; justify-content: space-between;">
			<h3 class="card-header"><a href="' . VIRTUAL_PATH . 'sports/nfl/feed_view.php?id=' . (int)$row['FeedID'] . '">NFL</h3>
			<div class="card-body">
				<h5 class="card-title">Special title treatment</h5>
				<h6 class="card-subtitle text-muted">Support card subtitle</h6>
			</div>
			<img style="height: 200px; width: 100%; display: block;" src="../images/nfl.jpg" alt="nutrition image">
			<div class="card-body">
				<p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p>
			</div>
				<ul class="list-group list-group-flush">
		...
		<div class="col-lg-4 card mb-3" style="width: 25%; display: flex; justify-content: space-between;">
			<h3 class="card-header"><a href="' . VIRTUAL_PATH . 'sports/nba/feed_view.php?id=' . (int)$row['FeedID'] . '">NBA</h3>
			<div class="card-body">
				<h5 class="card-title">Special title treatment</h5>
				<h6 class="card-subtitle text-muted">Support card subtitle</h6>
			</div>
			<img style="height: 200px; width: 100%; display: block;" src="../images/nba.jpg" alt="fitness image">
			<div class="card-body">
				<p class="card-text">Some quick example text to build on the card title and make up the bulk of the cards content.</p>
			</div>
				<ul class="list-group list-group-flush">
