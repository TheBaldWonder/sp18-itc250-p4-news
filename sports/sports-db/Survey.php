...
class Survey
{
	 ...
	 public $aQuestion = Array();#stores an array of question objects
	...
	{#constructor sets stage by adding data to an instance of the object
		...
		if($this->SurveyID == 0){return FALSE;} //if no survey cut the database export / kill
	...
	function showArticle()
	{
        ...
        {#be certain there are questions
                ...
                $myReturn .= '
                    <div class="panel panel-default">
                        <div class="panel-heading">
                            <h3 class="panel-title">' . $question->QuestionID . ') ' . $question->Text . ' ' . $question->Description . '</h3>
                        </div>
			...
			echo "There is currently no feed for this topic.";	
        }
        return $myReturn;
