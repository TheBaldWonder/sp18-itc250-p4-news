...
$sub_folder = 'p4-xml/';//If app installed in subfolder, place here.  name of folder, no leading or trailing forward or backslash
...
define('PREFIX', 'p4_'); #Adds uniqueness to DB table names.  Limits hackability, naming collisions.  In WordPress the prefix is wp_
...
$config->copyright = 'Group Two &copy; ' . date('Y'); #goes inside footer - can be overwritten
...
$nav1['news/'] = "NEWS~The entrance to our Survey App";
$nav1['sports/index.php'] = "SPORTS~A demo page for building mysqli shared connection based applications.";
$nav1['health/index.php'] = "HEALTH~A demo page for building PDO connection based applications.";
$nav1['tech/index.php'] = "TECH~A demo for building postback forms";
