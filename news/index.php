...
{#records exist - process
	...
	{# process each row
		...
		<div class="card mb-3">
		<h3 class="card-header"><a href="' . VIRTUAL_PATH . 'news/feed_view.php?id=' . (int)$row['FeedID'] . '">' . dbOut($row['Title']) . '</a></h3>
		<div class="card-body">
		  <h5 class="card-title">' . dbOut($row['URL']) . '</h5>
		  <h6 class="card-subtitle text-muted"></h6>
		</div>
		<img style="width: 10%; display: block; margin-left: 1.5em; clear: both;" src="data:image/svg+xml;charset=UTF-8, alt="Card image">
		<div class="card-body">
		  <p class="card-text">' . dbOut($row['Description']) . '</p>
		</div>
